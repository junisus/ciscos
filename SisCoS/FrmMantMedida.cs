    ...
    public partial class FrmMantMedida : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlCommand cmd = cn.CreateCommand();
                cmd.CommandText = "sp_modificarTarifa";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void dgvDirectorio_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                MySqlCommand cmd = cn.CreateCommand();
                cmd.CommandText = "sp_modificarTarifaEstado";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            FrmNuevaMedida frmnm = new FrmNuevaMedida();
