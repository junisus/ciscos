...
namespace SisCoS
{
    public partial class FrmMantGasto : Form
    {
        ...
        private void FrmMantGasto_Load(object sender, EventArgs e)
        {
            getGasto();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "sp_modificarGasto";
        ...
        private void dgvDirectorio_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                MySqlCommand cmd = cn.CreateCommand();
                cmd.CommandText = "sp_modificarGastoEstado";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void exportarExcel()
        {
            ...
            try
            {
                ...
                ost.Cells[2, 1] = "GASTOSs";
                ost.Cells[3, 1] = "CUADRO RESUMEN";
                ost.Cells[5, 1] = "Nª:";
                ost.Cells[5, 2] = "IdGASTO";
        ...
        {
          FrmNuevoGasto  frmng = new FrmNuevoGasto();
